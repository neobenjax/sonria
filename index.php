...
<?php if ($sec=="odontopediatria"){ ?>
  ...
  <div class="sidebar_info" style="margin-left:30px;">
      ...
      <p><strong>¿Es verdad que el chupon o el habito de chuparse el dedo no permite el correcto crecimiento de los dientes de mis hijos?</strong><br />
      ...
      <p><strong>¿Que tipo de pasta dental deben usar, por que y hasta que edad?</strong><br />
...
1			<iframe width="640" height="480" src="//www.youtube.com/embed/g76rFnnTa7M?rel=0" frameborder="0" allowfullscreen></iframe>
  ...
  <div class="sidebar_info" style="margin-left:30px;">
      ...
      <p><strong>¿Por que se mueven mis dientes?</strong><br />
...
<?php if ($sec=="cirugia"){ ?>
  ...
  <div class="sidebar_info" style="margin-left:30px;">
      ...
      <p><strong>¿Me las debo sacar?</strong><br />
      ...
      <p><strong>¿Ya no debo someterme a una cirugia?</strong><br />
	...
	<div class="sidebarRight" style="background:url(img/back_membresia.jpg)" >
		...
		<div class="sidebar_info" style="width:320px; overflow: auto; height:470px;">
			<p>Con la Membres&iacute;a Sonr&iacute;a contar&aacute;s con*: </p>
				...
				<li>Aplicaci&oacute;n de fl&uacute;or sin costo a ni&ntilde;os menores de 10 a&ntilde;os anualmente.</li>
				<li>Radiograf&iacute;a periapical para diagn&oacute;stico y tratamiento sin costo.</li>
				<li>Fisioterapia oral personalizada.</li>
				<li>Al contratar un paquete completo de brackets, los estudios para iniciar el tratamiento son sin Costo. No aplica para Invisalign</li>
				...
				<li>Opci&oacute;n de Pagos a Meses Sin Intereses con tarjetas bancarias participantes.</li>
			</ul>
			<p></p>
			...
			<p> </p>
			<p> </p>
			<li>*Al adquirir la Membres&iacute;a Sonr&iacute;a adquieres los beneficios de ser Paciente Sonr&iacute;a. El costo de la Membres&iacute;a Sonr&iacute;a no es reembolsable.</li>
			<li>*Descuento no acumulable con otras promociones, descuentos, ofertas, precios especiales, o convenios. En caso de tomar la Opci&oacute;n de pagos a meses sin intereses, no aplican descuestos o promociones adicionales.</li>
...
<?php if ($sec=="membresiapaypal"){ ?>
	 <div class="sidebarRight" >
		...
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
			...
			<input type="image" src="https://www.paypalobjects.com/es_XC/MX/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal, la forma mas segura y rapida de pagar en liÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­nea.">
...
<?php if ($sec=="financiamiento"){ ?>
	<div class="sidebarRight" style="background:url(img/back_financiamiento.jpg)" >
		...
		<div class="sidebar_info secciones">
			...
			<li>*La Opci&oacute;n de meses sin intereses no es acumulable con otras promociones, descuentos, ofertas, precios especiales, o convenios.</li>
		</div>
	</div>
...
<?php if ($sec=="dolor_de_muela"){ ?>
	<div class="sidebarRight" >
		...
		<div class="sidebar_info" style="margin-left:30px;">
			...
			<ul>
				<li><a href="?s=terceros_molares_muela_del_juicio">Muelas del juicio</a></li>
				<li><a href="?s=hipersensibilidad_sensibilidad_en_los_dientes">Hipersensibilidad en los dientes</a></li>
				<li><a href="?s=halitosis_mal_aliento">Mal aliento</a></li>
	...
	<div class="sidebarRight" >
		...
		<div class="sidebar_info" style="margin-left:30px;">
			...
			<ul>
				...
				<li>Evitar respirar por la boca para que no se sequen las enc&iacute;as. Alimentarse seg&uacute;n una dieta rica en frutas, verduras, cereales y baja en grasa y az&uacute;cares.</li>
...
<?php if ($sec=="periodontitis"){ ?>
	<div class="sidebarRight" >
		...
		<div class="sidebar_info" style="margin-left:30px;">
			...
			<h4>Tambi&eacute;n puedes leer de: </h4>
			<ul>
				<li><a href="?s=dolor_de_muela">Dolor de muela</a></li>
				<li><a href="?s=terceros_molares_muela_del_juicio">Muelas del juicio</a></li>
				<li><a href="?s=hipersensibilidad_sensibilidad_en_los_dientes">Hipersensibilidad en los dientes</a></li>
				<li><a href="?s=halitosis_mal_aliento">Mal aliento</a></li>
...
<div class="sidebarRight" style="background:url(img/back_franquicias.jpg)" >
		...
		<p>En 1992 en Colombia nace Cl&iacute;nicas Dentales SONR&Iacute;A gracias al suenio de lograr que el acceso a los servicios de salud oral fuera posible para toda la familia en cualquier nivel social.</p>
